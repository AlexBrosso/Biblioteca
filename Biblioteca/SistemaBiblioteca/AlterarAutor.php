<?php
  ...
  if($autor->getOperacao() == "ALTERAR AUTOR"){
    $autor->updateAutor();
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active">Alterar Autor</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container theme-showcase" role="main">
      ...
      <div class="jumbotron">
        ...
        <h1 class="col text-center">Alteração de Autores</h1>
        <div class="col text-center">
          <h5>Preencha os campos abaixo para realizar a alteração</h5>
        </div>

        <!--- Formulário de Alteração de Autor --->

        <div class=>
          <form  method="POST" id="alterAutor">
            <br>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="nome" placeholder="Digite aqui o nome do autor" name="txtNome" value="<?php echo $autor->getNome(); ?>" required>
            </div>
            <input type="submit" class="btn btn-primary btn-dark " value="Alterar Autor" name="btnOperacao"/>
